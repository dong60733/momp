        ...
        \item 孤立奇点 $z=1$。
              \begin{itemize}
                \item 若 $\displaystyle\ln{z}|_{z=1}=0$ 为二阶极点，\\[10pt]
                      ...
                      = \lim_{z\to 1}\frac{1}{\ln{z}+2}\textcolor{red}{(L'Hospital)}
                      =\frac{1}{2}$.
...
\begin{solution}
    \begin{enumerate}[(1)]
        \item 令 $t=\dfrac{1}{z}$，而 $\cos{z} = 1 - \dfrac{1}{2}z^{2} + \mathcal{O}(z^2)$，\\[12pt]
              故展开式为 $t(1 - \dfrac{1}{2}t^{-2} + \mathcal{O}(z^2)) = t - t^{-1} + \dfrac{1}{\mathcal{O}(t^1)}$, $\infty$ 为本性奇点,\\[12pt]
              即$\text{res}\ f(\infty) = -a_1 = -1$.
        \item 令 $t=\dfrac{1}{z}$，而 $\text{e}^{z} = 1 + z + \dfrac{1}{2}z^2 + \dfrac{1}{3!}z^3 + \mathcal{O}(z^3)$,\\[12pt]
              故展开式为 $(\dfrac{1}{t^2}+1)(1+\dfrac{1}{t}+\dfrac{1}{2}\cdot\dfrac{1}{t^2}+\cdots)$, $\infty$ 为本性奇点,\\[12pt]
        ...
        \item 令 $t=\dfrac{1}{z}$，原式可化为 $\displaystyle\frac{\sqrt{(1-t)(1-2t)}}{t}$.\\[12pt]
              ...
              故展开式为 $\displaystyle t^{-1}\cdot(-1)^m(1-\frac{1}{2}t-\frac{1}{8}t^2+\cdots)\cdot(-1)^n(1-t-\frac{1}{2}t^2+\cdots).$\\[12pt]
              整理得到 $\displaystyle(-1)^{m+n}(t^{-1}-\frac{3}{2}-\frac{1}{8}t-\frac{7}{16}t^2+\cdots)$. $\infty$ 为一阶奇点,\\[12pt]
              即$\text{res}\ f(\infty) = -a_1 = (-1)^{m+n}\dfrac{1}{8}$.
    \end{enumerate}
\end{solution}
